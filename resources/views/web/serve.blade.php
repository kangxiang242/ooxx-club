@extends('web.layout')
@section('title', mb_substr($product->city->name,0,2)."外送茶 ".$product->name)
@section('style')
    @parent
...
<header>
    <div class="wrapper" id="wrapper">
        <div class="logo-sec">
            <a href="{{ url('/') }}">
                ...
                <p class="phone" id="phone">
                    喝茶加LINE：<span style="font-size: 19px;">{{ liaison_get('line_id') }}</span>
                </p>
            </a>
        </div>
        ...
        <div class="m-nav">
            ...
            <a href="{{ liaison_get('line_url') }}" class="contect"  target="_blank" rel="nofollow noopener noreferrer" oncontextmenu="return false;" data-inquire data-inquire-type="line" datainquire data-inquire-position="導航區">
                <div class="text" style="line-height: 1;">
                    ...
                    <div>
                        <p>加LINE預約</p>
                        <p style="font-size: 15px;">{{ liaison_get('line_id') }}</p>
                    </div>
                </div>
            </a>
        </div>
...
<div class="infobody">
        ...
        <ul class="spec-list" style="z-index: 2">
            ...
            @endforeach
                <li class="list-vedio">
                    ...
                    <div class="screen">
                        <img src="{{ asset_upload($product->video_cover) }}" alt="Video">
                    </div>
                </li>
        </ul>
    </div>
    ...
    <div class="info" style="z-index:3">
        ...
        <div class="location">
                ...
                <span>{{ mb_substr($product->city->name,0,-1) }}</span>
        </div>
        <ul class="codebox">
        ...
        <div class="addbox">
            ...
            <ul class="addlist">
                ...
                @endforeach
                <a href="{{ liaison_get('line_url') }}" class="contect" target="_blank" rel="nofollow noopener noreferrer" oncontextmenu="return false;" data-inquire data-inquire-type="line" datainquire data-inquire-position="詳情區">
                    <div class="text">
                        <svg t="1691137092658" class="lineicon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="8095" width="200" height="200"><path d="M826.24 420.821333a26.922667 26.922667 0 0 1 0 53.802667H751.36v48h74.88a26.88 26.88 0 1 1 0 53.717333h-101.802667a26.922667 26.922667 0 0 1-26.752-26.837333V345.941333c0-14.72 12.032-26.88 26.88-26.88h101.802667a26.88 26.88 0 0 1-0.128 53.76H751.36v48h74.88z m-164.48 128.682667a26.88 26.88 0 0 1-26.922667 26.752 26.368 26.368 0 0 1-21.76-10.666667l-104.234666-141.525333v125.44a26.88 26.88 0 0 1-53.632 0V345.941333a26.752 26.752 0 0 1 26.624-26.794666c8.32 0 16 4.437333 21.12 10.837333l105.045333 142.08V345.941333c0-14.72 12.032-26.88 26.88-26.88 14.72 0 26.88 12.16 26.88 26.88v203.562667z m-244.949333 0a26.965333 26.965333 0 0 1-26.922667 26.837333 26.922667 26.922667 0 0 1-26.752-26.837333V345.941333c0-14.72 12.032-26.88 26.88-26.88 14.762667 0 26.794667 12.16 26.794667 26.88v203.562667z m-105.216 26.837333H209.792a27.050667 27.050667 0 0 1-26.88-26.837333V345.941333c0-14.72 12.16-26.88 26.88-26.88 14.848 0 26.88 12.16 26.88 26.88v176.682667h74.922667a26.88 26.88 0 0 1 0 53.717333M1024 440.064C1024 210.901333 794.24 24.405333 512 24.405333S0 210.901333 0 440.064c0 205.269333 182.186667 377.258667 428.16 409.941333 16.682667 3.498667 39.381333 11.008 45.141333 25.173334 5.12 12.842667 3.370667 32.682667 1.621334 46.08l-6.997334 43.52c-1.92 12.842667-10.24 50.602667 44.757334 27.52 55.082667-22.997333 295.082667-173.994667 402.602666-297.6C988.842667 614.101333 1024 531.541333 1024 440.064" p-id="8096"></path></svg>加Line洽詢 加值服務價格
                    </div>
                </a>
            </ul>
        </div>
