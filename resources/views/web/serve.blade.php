...
<div class="infobody">
    <div class="pic">
        ...
        <img id="cover" src="{{ asset_upload($product->thumbnail('small','cover')) }}" data-src="{{ asset_upload($product->thumbnail('small','cover')) }}" data-lazyload alt="{{ $product->name }}" style="width: 100%;    position: relative;z-index: 2;">
