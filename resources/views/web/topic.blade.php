...
@section('content')
    <header style="display: block">
        <div class="wrapper" id="wrapper">
            ...
            <div class="m-nav">
                <div>
                    <a href="{{ url('/') }}" class="base" target="_blank" rel="nofollow noopener noreferrer" class="line button" oncontextmenu="return false;" data-inquire data-inquire-type="line" datainquire data-inquire-position="導航區">
