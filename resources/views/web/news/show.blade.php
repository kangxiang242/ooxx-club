            ...
            <div class="news-box">
                ...
                <div class="right-sticky">
                    <div class="right">
                        ...
                        <!-- <div class="btnbox">
                            <a href="{{ liaison_get('line_url') }}" target="_blank" class="button ripple" data-inquire="" data-inquire-type="line" data-inquire-position="top">
                                ...
                                <div class="text shake1">
                                    ...
                                    <p>
                                        ...
                                        <span class="btn-num">{{ liaison_get('line_id') }}</span>
                                    </p>
                                </div>
