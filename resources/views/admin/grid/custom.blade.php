                ...
                <li>
                    ...
                    <div class="mailbox-attachment-info">
                        ...
                        <div class="d-flex justify-content-between item">
                            <span class="mailbox-attachment-name">{!! $row->column('team.name').' '.$row->column('name') !!}</span>
                        </div>
                        <div class="d-flex justify-content-between item" style="margin-top: 12px">
                            <div>{!! $row->column('category') !!}</div>
                        </div>
                        <span class="d-flex justify-content-between" style="margin-top: 12px">
