    ...
    <a href="{{ url('product/'.$goods->id) }}">
        <div class="cover">
            ...
            <div class="master {{ $current_count%7==0?"have-video":"" }}" >
                <img class="goods-img" fetchpriority="low" src="{{ imageToBase64('/uploads/'.$goods->thumbnail('small','cover')) }}" data-lazyload data-src="{{ asset_upload($goods->thumbnail('450','cover')) }}" data-cover-id="{{ $goods->id }}" alt="{{ $goods->name }}">
