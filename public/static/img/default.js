...
function makeSelect(obj, fn) {
	...
	$selectBox.find('.selectStyle').each(function(){
		...
		$(this).find('.selectList').width(obj.closest('.selectBoxWrap').eq(0).width());
		...
		for(var i=0;i<=$(this).find('.selectBox option').length-1;i++){
			...
			$(this).find('.selectList').append('<div class="option"><a href="#"' + value + ' >'+$(this).find('.selectBox option').eq(i).text()+'</a></div>');
...
function selectBoxReFresh(obj){
	...
	$selectBox.find('.selectStyle').each(function(){
		...
		$(this).find('.selectList').width($(this).closest('.selectBoxWrap').eq(0).width());
